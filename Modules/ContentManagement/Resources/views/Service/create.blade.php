...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#servicesAddForm').formValidation({
            ...
            $('#servicesAddForm').formValidation('revalidateField', 'title');
...
<div class="box box-primary">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form id="servicesAddForm" method="POST" action="{{ route('admin.content-management.services.store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="fileupload fileupload-new" data-provides="fileupload">
                    <div class="fileupload-new thumbnail" style="width: 600px; height: auto;">
                        <img src="{{ asset('uploads/content-management/services/default-img.jpg') }}" alt="">
                    </div>
