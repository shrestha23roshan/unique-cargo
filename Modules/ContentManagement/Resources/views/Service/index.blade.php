...
<div class="box">
    <div class="box-header with-border">
      <a href="{{ route('admin.content-management.services.create') }}"><button class="btn btn-primary">Add New &nbsp;<i class="fa fa-plus"></i></button></a>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
                ...
                <tr>
                    ...
                    <td class="image">
                        @if($record->attachment)
                            <img src="{{ asset('uploads/content-management/services/' . $record->attachment) }}" alt="{{ $record->name }}" width="200">
                        @endif
                    </td>
                    <td>
                    ...
                    <td>
                        <a href="{{ route('admin.content-management.services.edit', $record->id) }}" title="Edit message"><button class="btn btn-primary btn-flat"><i class="fa fa-edit"></i></button></a>&nbsp;
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        swal({
            ...
            $.ajax({
                type: "DELETE",
                url: "{{ url('/admin/content-management/services') }}"+"/"+id,
                dataType: 'json',
